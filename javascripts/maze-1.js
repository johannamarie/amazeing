const walls = [
    ...
    { type: 'horizontal', x: 30, y: 40, w: 5, h: 1, id: 18 },
    ...
    { type: 'horizontal', x: 25, y: 50, w: 5, h: 1, id: 24 },
    { type: 'horizontal', x: 35, y: 50, w: 5, h: 1, id: 25 },
    ...
    { type: 'horizontal', x: 65, y: 60, w: 5, h: 1, id: 31 },
    ...
    { type: 'horizontal', x: 50, y: 70, w: 10, h: 1, id: 36 },
    ...
    { type: 'horizontal', x: 10, y: 90, w: 25, h: 1, id: 42 },
    { type: 'horizontal', x: 45, y: 90, w: 10, h: 1, id: 43 },
    { type: 'horizontal', x: 60, y: 90, w: 15, h: 1, id: 44 },
    { type: 'horizontal', x: 80, y: 90, w: 5, h: 1, id: 45 },
